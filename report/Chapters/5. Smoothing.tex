...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Spectra of the original and the smoothed picture after \texttt{fftshift}. The axes are DFT indices; the centre $(597, 448)$ corresponds to $k_x = k_y = 0$.}
